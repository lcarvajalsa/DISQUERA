...
from trimestreV.views import bienvenida, categoriaEdad
from trimestreV.views import obtenerMomentoActual, contenidoHTML 
from trimestreV.views import miPrimeraPlantilla
